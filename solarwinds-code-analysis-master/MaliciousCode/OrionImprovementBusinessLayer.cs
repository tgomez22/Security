        ...
        if (string.IsNullOrEmpty(this.proxyString))
        {
          try
          {
            ...
            else
            {
              ...
              if (instance.IsValid)
                this.proxyString = this.proxyString + ":" + instance.Uri + "\t" + (instance.Credential is UsernamePasswordCredential credential15 ? credential15.Username : (string) null) + "\t" + (instance.Credential is UsernamePasswordCredential credential16 ? credential16.Password : (string) null);
            }
          }
          catch
          {
